...
export const ProjectToolbar: React.FC = () => {
  ...
  return (
    <div className="glass-panel project-toolbar" style={{
      ...
      <div style={{ display: 'flex', width: 316, gap: 4 }}>
        
        {/* 对齐 1/3 (照片轴): 排序 */}
        <div style={{ flex: 1, position: 'relative' }}>
          <button className="ios-button-small ios-button ios-button-subtle" style={{ width: '100%', borderRadius: 8, fontSize: 12, height: 32, color: 'rgba(255,255,255,0.7)', transition: 'all 0.2s', padding: 0 }} onClick={(e) => { e.stopPropagation(); setShowSortMenu(!showSortMenu); }}>
